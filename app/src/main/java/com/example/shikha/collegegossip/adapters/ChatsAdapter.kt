...
import com.example.shikha.collegegossip.ViewFullImageActivity
...
class ChatsAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, position: Int): ViewHolder {
        return if (position ==1){
            val view: View = LayoutInflater.from(mContext).inflate(com.example.shikha.collegegossip.R.layout.message_item_right,parent,false)
            ViewHolder(view)
        }
        else{
            val view: View = LayoutInflater.from(mContext).inflate(com.example.shikha.collegegossip.R.layout.message_item_left,parent,false)
            ViewHolder(view)
        }
        ...
        val ref = FirebaseDatabase.getInstance().reference.child("Chats")
                ...
                .addOnCompleteListener {task->
                    if (task.isSuccessful){
                        ...
                        Toast.makeText(holder.itemView.context,
                                "Failed,Not Deleted.",Toast.LENGTH_SHORT).show()
                    }
                }
    }
